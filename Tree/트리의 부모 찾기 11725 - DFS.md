![image](https://user-images.githubusercontent.com/74396651/158946863-db65a36f-566a-4021-96fe-191e55e964e0.png)

![image](https://user-images.githubusercontent.com/74396651/158946904-802c0c03-8af4-4a4b-a276-3e037fe8a6f6.png)
...
public class 트리의부모찾기_DFS_11725 {
	static class Graph{
		...
		public void dfs(ArrayList<ArrayList<Integer>> adList, int[] parents, int start, int parent) {
			...
			// i에 arraylist 값이 담기고
			// arraylist 값(i)과  parent 값이 다르다면 밑으로 쭉쭉 내려간다~~ 
